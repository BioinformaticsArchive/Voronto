...
public class Cell implements Cloneable {
	...
	public int getNumMatchedTerms(ExpressionData md)
		...
		for(String id:this.term.geneIds)
			{
			if(md.geneNamesHash.containsKey(id))
				cont++;
			}
	 ...
	 * @param column
	 */
	public float getExpression(ExpressionData md, int column)
		{
	...
	public void computeGOExpression(ExpressionData md)
		...
		//System.out.println("Time in mapping conditions for "+term.name+" takes "+(System.currentTimeMillis()-t)/1000.0+" s");
